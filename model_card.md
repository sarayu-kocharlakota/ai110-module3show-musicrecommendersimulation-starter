...
Creating this music recommender taught me that even though everything seems so simple, the logic behind everything is much more complicated than previously assumed. For example, not knowing how much weight to give each feature. The most shocking thing to see for me was if no song in the dataset matched the users preferences, instead of notifying the user, the system just ignored that preference. Platforms such as Spotify and Apple Music don't have this problem nearly as bad as the system I built. I definitely had a mindset shift on how music recommender platforms actually operate during the making of this project. Recommendations that feel like magic when they pop up at the top, are really just simple math and scorings that are weighted. I feel like models are amazing at catching trends and giving great suggestions based on observed data, but humans are the main source of providing the context, intention, and meaning. All music recommenders work with human judgement, they aren't automated. I realized that simple algorithms still have the great ability to produce someting meaningful and personal. Also, just after a few clicks here and there, a system can fully identify a user's likes and dislikes and give personalized suggestions. AI tools helped me understand certain aspects of this project as well as providing guidance in places I was stuck at when brainstorming for ideas I wouldn't have thought of immediately. If I extended, this project, I would surely try to implement new features in my system such as being able to identify when two moods such as "chill" and "relaxed" are basically the same, rather than treating them as two completely different moods. 
